 ...
 * 描述:
 */
public class MyBaseBindingViewHolder<B extends ViewDataBinding> extends RecyclerView.ViewHolder {
    private B mBinding;
    protected MyBaseBindingRecyclerViewAdapter mBindingRecyclerViewAdapter;

    public MyBaseBindingViewHolder(MyBaseBindingRecyclerViewAdapter bindingRecyclerViewAdapter, B binding) {
