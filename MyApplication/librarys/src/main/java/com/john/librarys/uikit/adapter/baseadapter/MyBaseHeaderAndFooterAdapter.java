 ...
 */
public class MyBaseHeaderAndFooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    MyBaseHeaderAndFooterAdapter(RecyclerView.Adapter innerAdapter) {
