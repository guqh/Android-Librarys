...
public class BadgeView extends TextView {
    ...
    private boolean mHideOnNull = false;
...
//        setBackgroundResource(R.drawable.selector_navicon_bage_bg);
//        setTextColor(getResources().getColor(R.drawable.selecter_refuse_cancle_text));
//        setBackground(9, Color.parseColor("#fc4d01"));
