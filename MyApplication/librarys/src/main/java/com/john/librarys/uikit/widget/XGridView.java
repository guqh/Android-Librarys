 ...
 * See {@link XGridView#addHeaderView(View, Object, boolean)}
 * See {@link XGridView#addFooterView(View, Object, boolean)}
 */
public class XGridView extends GridView {
     ...
     */
    public void notifyDataSetChanged() {
        Field dataSetObserver = null;
        try {
            Field dataSetObserverField = AbsListView.class.getDeclaredField("mDataSetObserver");
            dataSetObserverField.setAccessible(true);
            DataSetObserver observer = (DataSetObserver) dataSetObserverField.get(this);
            if(observer != null) {
                observer.onChanged();
            }
        } catch (NoSuchFieldException e) {
