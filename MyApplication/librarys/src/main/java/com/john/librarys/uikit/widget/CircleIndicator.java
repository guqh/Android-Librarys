...
public class CircleIndicator extends LinearLayout {
    ...
    protected final static int DEFAULT_INDICATOR_WIDTH = 5;
    protected ViewPager mViewpager;
    protected int mIndicatorMargin = -1;
    protected int mIndicatorWidth = -1;
    protected int mIndicatorHeight = -1;
    protected int mAnimatorResId = R.animator.scale_with_alpha;
    protected int mAnimatorReverseResId = 0;
    int mIndicatorBackgroundResId = R.drawable.white_radius;
    int mIndicatorUnselectedBackgroundResId = R.drawable.white_radius;
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (mViewpager != null && mViewpager.getAdapter() != null) {
            ...
            mInternalPageChangeListener.onPageSelected(getViewPageCurrentItem());
        }
    }
    ...
    protected void onPageSelcted(int position) {
        if (mViewpager.getAdapter() == null || getViewPageCount() <= 0) {
            return;
        }
    ...
    private DataSetObserver mInternalDataSetObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            int newCount = getViewPageCount();
            int currentCount = getChildCount();

            if (newCount == currentCount) {  // No change
                return;
            } else if (mLastPosition < newCount) {
                mLastPosition = getViewPageCurrentItem();
            } else {
                mLastPosition = -1;
            }
    ...
    private void createIndicators() {
        removeAllViews();
        int count = getViewPageCount();
        if (count <= 0) {
            return;
        }
        int currentItem = getViewPageCurrentItem();
