 ...
 * 描述:AdapterView适配器
 */
public abstract class MyBaseAdapterViewAdapter<M> extends BaseAdapter {
    ...
    public MyBaseAdapterViewAdapter(Context context, int itemLayoutId) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MyBaseAdapterViewHolder viewHolder = MyBaseAdapterViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
     ...
     * @param helper
     */
    protected void setItemChildListener(MyBaseViewHolderHelper helper) {
    }
